export function Testimonials() {
  const testimonials = [
    ...
    {
      quote: "Clients keep saying 'you really did your homework.' I didn't — MeetReady did.",
      initials: "SP",
      name: "Sarah P.",
  ...
  return (
    <section className="py-16 md:py-24 px-6">
      <div className="max-w-6xl mx-auto">
        {/* Context Line */}
        <p className="text-center text-text/70 mb-12 max-w-3xl mx-auto">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-surface border border-text/10 rounded-xl p-8 hover:border-accent/30 transition-colors"
            >
              {/* Quote */}
              <div className="mb-6">
