...
export const metadata: Metadata = {
  title: 'Privacy Policy - MeetReady',
  description: 'Privacy Policy for MeetReady - Learn how we collect, use, and protect your personal information.',
}
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-text/80 mb-4">When you use MeetReady, we collect information that you provide directly to us, including:</p>
            ...
            <p className="text-text/80 mb-4">When you access and use MeetReady, we automatically collect certain information, including:</p>
            <ul className="list-disc pl-6 mb-4 text-text/80 space-y-2">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-text/80 space-y-2">
              <li><strong>Service Delivery:</strong> To provide, operate, and maintain MeetReady's meeting preparation features</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-text/80 space-y-2">
              ...
              <li>Protect the rights, property, or safety of MeetReady, our users, or others</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-text/80 mb-4">
              You can revoke MeetReady's access to your Google Calendar at any time through your Google Account settings at <a href="https://myaccount.google.com/permissions" className="text-accent hover:underline">myaccount.google.com/permissions</a>. Note that revoking access will prevent MeetReady from syncing your calendar and providing meeting preparation services.
            </p>
      ...
      <footer className="bg-surface border-t border-text/10 mt-12">
        <div className="max-w-4xl mx-auto px-6 py-6">
          <p className="text-sm text-text/60 text-center">
            © {new Date().getFullYear()} MeetReady. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
