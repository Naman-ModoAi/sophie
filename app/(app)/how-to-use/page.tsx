...
export default async function HowToUsePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="space-y-16">
        ...
        <section>
          <div className="flex items-baseline gap-3 mb-4">
            ...
            <h2 className="text-3xl font-bold text-text">Sign In with Google</h2>
          </div>
          ...
          {/* Screenshot */}
          <div className="mb-6 rounded-lg border border-text/10 shadow-sm overflow-hidden">
        ...
        <section>
          <div className="flex items-baseline gap-3 mb-4">
            ...
            <h2 className="text-3xl font-bold text-text">Calendar Connection</h2>
          </div>
          ...
          <ul className="space-y-2 text-text/70 mb-6">
            <li className="flex items-start gap-2">
              <svg className="w-5 h-5 text-accent mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
        ...
        <section>
          <div className="flex items-baseline gap-3 mb-4">
            ...
            <h2 className="text-3xl font-bold text-text">View Your Meetings</h2>
          </div>
        ...
        <section>
          <div className="flex items-baseline gap-3 mb-4">
            ...
            <h2 className="text-3xl font-bold text-text">Generate Prep Notes</h2>
          </div>
        ...
        <section>
          <div className="flex items-baseline gap-3 mb-4">
            ...
            <h2 className="text-3xl font-bold text-text">Edit Attendee Information</h2>
          </div>
      ...
      {/* Footer CTA */}
      <div className="mt-16 pt-8 border-t border-text/10">
