...
export default async function HowToUsePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      {/* Page Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-serif font-bold text-text-primary mb-4">How to Use Sophie</h1>
        <p className="text-lg text-text-secondary leading-relaxed">
          Sophie helps you prepare for meetings by automatically researching attendees and companies.
      ...
      <div className="space-y-16">
        ...
        <section>
          ...
          <p className="text-text-secondary leading-relaxed mb-6">
            Sophie automatically detects attendee names and companies from calendar invites, but sometimes
