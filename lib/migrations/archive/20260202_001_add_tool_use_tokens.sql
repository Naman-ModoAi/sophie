-- Migration: Add tool use prompt token tracking
-- Date: 2026-02-02
-- Description: Add tool_use_prompt_tokens column to track grounding tool overhead

-- Add new column to token_usage table
...
-- Drop and recreate track_token_usage function with new parameter
