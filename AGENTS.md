...
Sophie is a Next.js 14 frontend with Google OAuth authentication and calendar integration. It uses the App Router, TypeScript, Tailwind CSS, Supabase for data, and iron-session for session management.
